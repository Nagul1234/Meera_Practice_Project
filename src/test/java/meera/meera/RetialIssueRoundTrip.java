...
public class RetialIssueRoundTrip {
	 ...
	 static int n=(adult+child+infant);
				...
				private static final int RANDOM_STRING_LENGTH = 6;
		          ...
		          public  	HSSFSheet sheet;
					...
					public static void retailIssueRoundTrip()throws InterruptedException, IOException {
			...
			//driver.get("http://172.168.10.101/ota/otadev/srm/trunk/dashboard#!");
				       Thread.sleep(10000);
						...
						Thread.sleep(2000);
						driver.findElement(By.xpath("//*[@id=\"collapse1\"]/div/div[2]/div[2]/div[2]/div/div/label[4]/span")).click();
						Thread.sleep(2000);
						driver.findElement(By.xpath("//*[@id=\"collapse1\"]/div/div[2]/div[2]/div[3]/div/div/div/label[2]/span")).click();
						Thread.sleep(2000);
						...
						Thread.sleep(2000);
						driver.findElement(By.xpath("//*[@name='ReturnDate[1]']")).click();
						Thread.sleep(2000);
						WebElement returndate=driver.findElement(By.xpath("(//a[contains(text(),'17')])[3]"));
						JavascriptExecutor executorreturndate = (JavascriptExecutor)driver;
						executorreturndate.executeScript("arguments[0].click();", returndate);		
				...
				System.out.println("Offiline flight link tested successfully");
					...
					//Round Trip		
					driver.findElement(By.xpath("//*[@name='marketinground[]']")).sendKeys("BA");
					driver.findElement(By.xpath("//*[@name='flightnoround[]']")).sendKeys("72");
					driver.findElement(By.xpath("//*[@name='operatinground[]']")).sendKeys("BA");
					Thread.sleep(2000);
					driver.findElement(By.xpath("//*[@name='equipmenttyperound[]']")).sendKeys("British Aerospace BAe 146-100");
					Thread.sleep(2000);
					WebElement element12=driver.findElement(By.xpath("//*[@name='airclassround[]']"));
					Select drop22=new Select(element12);
					drop22.selectByVisibleText("Economy");
					Thread.sleep(1000);
					driver.findElement(By.xpath("(//*[@id=\"oneWay\"]/div[2]/div/div[2]/div/div[2]/div/div[2]/div/span/span[1]/span)[2]")).click();
					driver.findElement(By.xpath("//span[@class='select2-search select2-search--dropdown']/input")).sendKeys("D");
					driver.findElement(By.xpath("//span[@class='select2-search select2-search--dropdown']/input")).sendKeys(Keys.ENTER);
					//driver.findElement(By.xpath("//*[@class='select2-selection select2-selection--single']")).click();
					//driver.findElement(By.xpath("/html/body/span/span/span[1]/input")).sendKeys("D");
					//driver.findElement(By.xpath("/html/body/span/span/span[1]/input")).sendKeys(Keys.ENTER);
					//driver.findElement(By.xpath("//*[@class='select2-search__field']")).sendKeys("D");
					//driver.findElement(By.xpath("//*[@class='select2-search__field']")).sendKeys(Keys.ENTER);
					driver.findElement(By.xpath("//*[@name='departuretimeround[]']")).sendKeys("12:30");
					driver.findElement(By.xpath("//*[@name='arivaltimeround[]']")).sendKeys("06:30");
					driver.findElement(By.xpath("//*[@name='durationroundhh[]']")).sendKeys("06");
					driver.findElement(By.xpath("//*[@name='durationroundmm[]']")).sendKeys("00");			
					...
					driver.findElement(By.xpath("//*[@id=\"0\"]/div[1]/div[2]/div/span/span[1]/span/ul/li/input")).sendKeys("S2");
					driver.findElement(By.xpath("//*[@id=\"0\"]/div[1]/div[2]/div/span/span[1]/span/ul/li/input")).sendKeys(Keys.ENTER);
				...
				Thread.sleep(3000);
					...
					//REISSUE ADD
			public static void reissueAddRound() throws InterruptedException {
					int P=(n+1);
					...
					driver.findElement(By.xpath("//*[@id='"+P+"']/div[1]/div[2]/div/span/span[1]/span/ul/li/input")).sendKeys("S1");
					driver.findElement(By.xpath("//*[@id='"+P+"']/div[1]/div[2]/div/span/span[1]/span/ul/li/input")).sendKeys(Keys.ENTER);
					Thread.sleep(2000);
					driver.findElement(By.xpath("//*[@id='"+P+"']/div[1]/div[2]/div/span/span[1]/span/ul/li/input")).sendKeys("S2");
					driver.findElement(By.xpath("//*[@id='"+P+"']/div[1]/div[2]/div/span/span[1]/span/ul/li/input")).sendKeys(Keys.ENTER);
					Thread.sleep(2000);
					random =generateRandomString();
					Thread.sleep(2000);
				...
				driver.findElement(By.xpath("//*[@id='"+P+"']/div[2]/div[2]/div/input ")).sendKeys("4000");
					...
					Thread.sleep(1000);
					driver.findElement(By.xpath("//*[@id='"+n+"']/div[1]/div[2]/div/span/span[1]/span/ul/li/input ")).sendKeys("S1");
					driver.findElement(By.xpath("//*[@id='"+n+"']/div[1]/div[2]/div/span/span[1]/span/ul/li/input ")).sendKeys(Keys.ENTER);
					Thread.sleep(2000);
					driver.findElement(By.xpath("//*[@id='"+n+"']/div[1]/div[2]/div/span/span[1]/span/ul/li/input ")).sendKeys("S2");
					driver.findElement(By.xpath("//*[@id='"+n+"']/div[1]/div[2]/div/span/span[1]/span/ul/li/input ")).sendKeys(Keys.ENTER);
					Thread.sleep(2000);
					random =generateRandomString();
					Thread.sleep(2000);
			...
			public static void reissueResPenRound() throws InterruptedException {
					int R=(n+2);
					int P=(n+1);
					...
					driver.findElement(By.xpath("//*[@id='"+R+"']/div[1]/div[2]/div/span/span[1]/span/ul/li/input")).sendKeys("S1");
					driver.findElement(By.xpath("//*[@id='"+R+"']/div[1]/div[2]/div/span/span[1]/span/ul/li/input")).sendKeys(Keys.ENTER);
					Thread.sleep(2000);
					driver.findElement(By.xpath("//*[@id='"+R+"']/div[1]/div[2]/div/span/span[1]/span/ul/li/input")).sendKeys("S2");
					Thread.sleep(2000);
					driver.findElement(By.xpath("//*[@id='"+R+"']/div[1]/div[2]/div/span/span[1]/span/ul/li/input")).sendKeys(Keys.ENTER);
					Thread.sleep(2000);
					random =generateRandomString();
				...
				driver.findElement(By.xpath("//*[@id='"+P+"']/div[2]/div[2]/div/input ")).sendKeys("100");
					...
					//ONLY RESIDUAL
			public static void reissueResRound() throws InterruptedException {
				int r=(n+1);
