...
//RETAIL ISSUE
			public static  void retailIssue() throws InterruptedException {
	...
	//driver.get("http://172.168.10.101/ota/otadev/srm/trunk/dashboard#!");
		...
		driver.findElement(By.xpath("//*[@id='"+P+"']/div[2]/div[2]/div/input ")).sendKeys("4000");
			...
			public static void reissueResandPenalty() throws InterruptedException {
				JavascriptExecutor jse7 = (JavascriptExecutor) driver;
				jse7.executeScript("window.scrollBy(0,400)", "");
			int R=(n+2);
			int P=(n+1);
		...
		driver.findElement(By.xpath("//*[@id='"+P+"']/div[2]/div[2]/div/input ")).sendKeys("100");
			...
			//ONLY RESIDUAL
			public static void reissueRes() throws InterruptedException {
				JavascriptExecutor jse7 = (JavascriptExecutor) driver;
				jse7.executeScript("window.scrollBy(0,400)", "");
			int r=(n+1);
		...
		JavascriptExecutor jse6 = (JavascriptExecutor) driver;
			...
			driver.findElement(By.xpath("//*[@class='form-control cancellationpenalty'] ")).sendKeys("100");
			List<WebElement>  RefundM2 =driver.findElements(By.xpath("(//*[@name='m2Price[]'])"));
			RefundM2.get(2).sendKeys("20");
			List<WebElement>  RefundD =driver.findElements(By.xpath("(//*[@name='discountPrice[]'])"));
			RefundD.get(2).sendKeys("10");
			Thread.sleep(10000);
			driver.findElement(By.xpath("(//*[@class='btn btn-lightblue updatePrice btn-minwidth'])[2]")).click();
			Thread.sleep(1000);
			Alert alertv4 =driver.switchTo().alert();
		...
		/*try {
			driver.findElement(By.linkText("Click here to generate receipt")).click();
		WebElement receipt=driver.findElement(By.linkText("Click here to generate receipt.."));
		JavascriptExecutor newpay2=(JavascriptExecutor)driver;
		newpay2.executeScript("arguments[0].click();",receipt);
		Thread.sleep(4000);
		}
		catch(Exception R) {
			WebElement receipt3=driver.findElement(By.linkText("Click here to generate receipt"));
			JavascriptExecutor newpay3=(JavascriptExecutor)driver;
			newpay3.executeScript("arguments[0].click();",receipt3);
			driver.findElement(By.linkText("Click here to generate receipt..")).click();
		}*/
			//driver.findElement(By.linkText("Click here to generate receipt..")).click();
			driver.manage().timeouts().implicitlyWait(20,TimeUnit.SECONDS);
		...
		//	Thread.sleep(2000);
			...
			public static void partialReceipt1Issue() throws InterruptedException {
				...
				newpayP.executeScript("arguments[0].click();",NEWPAYP);
					...
					MOPCASH.selectByIndex(1);
					Thread.sleep(5000);
					driver.findElement(By.xpath("//*[@name='paymentamount[0][]']")).sendKeys("1300");
					Thread.sleep(2000);
					driver.findElement(By.xpath("//*[@name='receiveamt[12][]']")).clear();
					driver.findElement(By.xpath("//*[@name='receiveamt[12][]']")).sendKeys("1300");
					JavascriptExecutor jse2 = (JavascriptExecutor) driver;
					jse2.executeScript("window.scrollBy(0,600)", "");
					Thread.sleep(2000);
					driver.findElement(By.xpath("//*[@class='form-control receiveamt']")).click();
			...
			public static void partialReceipt1ReIssue() throws InterruptedException {
				WebElement NEWPAYP=driver.findElement(By.xpath("(//*[@class='btn btn-xs btn-darkblue'])[2]"));
				JavascriptExecutor newpayP=(JavascriptExecutor)driver;
				newpayP.executeScript("arguments[0].click();",NEWPAYP);
					driver.manage().timeouts().implicitlyWait(20,TimeUnit.SECONDS);
			...
			public static void partialReceipt2() throws InterruptedException {
				...
				newpayP.executeScript("arguments[0].click();",NEWPAYP);
					...
					MOPCASH.selectByIndex(1);
					Thread.sleep(5000);
					driver.findElement(By.xpath("//*[@name='paymentamount[0][]']")).sendKeys("200");
					Thread.sleep(2000);
					driver.findElement(By.xpath("//*[@name='receiveamt[12][]']")).clear();
					driver.findElement(By.xpath("//*[@name='receiveamt[12][]']")).sendKeys("200");
					JavascriptExecutor jse2 = (JavascriptExecutor) driver;
					jse2.executeScript("window.scrollBy(0,600)", "");
					Thread.sleep(2000);
					driver.findElement(By.xpath("//*[@class='form-control receiveamt']")).click();
			...
			public static void allReceipt() throws Exception {
				...
				//jse.executeScript("arguments[0].value='State Bank Of India ()';",banktype1);
